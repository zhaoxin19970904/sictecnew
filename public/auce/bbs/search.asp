...
<table width="760" border=0 align="center" cellpadding=0 cellspacing=0>
  <tbody>
    <tr> 
      <td width="787" bgcolor="#FFFFFF" ><table width="100%" align="center" bgcolor="#92b9fb" border="0" cellpadding="0" cellspacing="1">
          <tr> 
            <td height="27" background="backimg/bg1.gif"> <b><font color="#FFFFFF">-=&gt; 
              在线列表 <a href=javascript:; onClick="listonlinediv()">[显示详细列表]</a></font></b> 
              <IFRAME name=hiddenframe  frameBorder=0 width=0 height=0></IFRAME></td>
          </tr>
          <tr> 
            <td align="center" bgcolor="#FFFFFF" > <div id="listonline"></div> </td>
          </tr>
        </table></td>
    </tr>
    <tr> 
...
%> </td>
            ...
            <td width="379" onmouseover=javascript:this.bgColor='#F9FBFD' onmouseout=javascript:this.bgColor='#FFFFFF' bgcolor="#FFFFFF" height="19"  > 
              <% 
dim ts
ts=("发贴人:"&rs("user")&"<br>发贴时间:"&rs("date")&"  "&rs("time")&"<br>最后回复:"&rs("lastly")&"<br>最后回复时间:"&rs("retime"))
    if crely>0 then 
...
response.write"<a href=type.asp?id="&rs("id")&" title="""&ts&""" >"&rs("ubbname")&"</a>" 
        '当回复达到多页时显示
		if crely>10 then
		dim disppagesd
...
%> </td>
            ...
            <td width="122" height="19" bgcolor="#EEEEEE"><%=rs("date")&" "&rs("time")%></td>
          </tr>
          <%
