...
document.FORM1.ly.value+=NewCode;
...
function AddText(text) {
	if (document.FORM1.ly.createTextRange && document.FORM1.ly.caretPos) {      
		var caretPos = document.FORM1.ly.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.FORM1.ly.value += text;
	document.FORM1.ly.focus(caretPos);
}
function inputs(str)
{
AddText(str);
...
function paste(text) {
	if (opener.document.FORM1.ly.createTextRange && opener.document.FORM1.ly.caretPos) {      
		var caretPos = opener.document.FORM1.ly.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else opener.document.FORM1.ly.value += text;
	opener.document.FORM1.ly.focus(caretPos);
}
...
document.FORM1.ly.value=fontbegin+document.FORM1.ly.value+fontend;
document.FORM1.ly.focus();
}
}
...
function insertsmilie(smilieface){
	...
	document.FORM1.ly.value+=smilieface;
}
function gopreview()
{
document.forms[1].title.value=document.forms[0].subject.value;
document.forms[1].body.value=document.forms[0].ly.value;
