...
dim i
for i=1 to 30
response.Write("<img src=""PIC/heart/face"&i&".gif""><input type=""radio"" value=""PIC/heart/face"&i&".gif"" name=""heat""")
if i=1 then
...
字体： 
  ...
  <SELECT onchange="if(this.options[this.selectedIndex].value!=''){showcolor(this.options[this.selectedIndex].value);this.options[0].selected=true;}else {this.selectedIndex=0;}" name=color>
    ...
    <option style="background-color:<%="#008CBB"%>;color: <%="#008CBB"%>" value="<%="#008CBB"%>"><%="#008CBB"%></option>
...
<img onclick=Curl() src="pic/url.gif" width="22" height="22" alt="超级连接" border="0"> 
<img onclick=Cemail() src="pic/emai12.gif" width="23" height="22" alt="Email连接" border="0"> 
...
<IMG onclick=Cfly() height=22 alt=飞行字 src="pic/fly.gif" width=23 border=0> <IMG onclick=Cmarquee() height=22 alt=移动字 src="pic/move.gif" width=23 border=0> 
