  ...
  <TR>
    ...
    background=img/cla_bg2.gif>
            ...
            <tr>
              ...
              <table height="28" cellSpacing="0" cellPadding="0" border="0">
                <tr>
                  ...
                  <td><strong><%=classname%>邮件列表</strong></td>
                </tr>
              </table>
              </td>
            </tr>
      ...
      <table width="590" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="20" class="topic" width="273"><font color="#CC0000">成员</font></td>
          <td height="20" class="digi" width="317" align="left" valign="middle"><font color="#CC0000">EAML地址</font></td>
        </tr>
        <tr> 
