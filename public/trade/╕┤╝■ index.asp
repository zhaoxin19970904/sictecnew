...
<DIV align=center></DIV>
<DIV align=center> 
  <TABLE height=652 cellSpacing=0 cellPadding=0 width=770 border=0>
    <TBODY> 
    <TR> 
...
width="100%">
      ...
      border=0>
			...
			%>
              <table width="560" height="549" border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top"> 
					  ...
					  <A href="products.asp?id=<%=title_id(11)%>"><%=title_type(11)%></a>
                        </font></b></font><font color="#666666">&nbsp;</font><font color="#666666" face="Geneva, Arial, Helvetica, san-serif"><br>
                    <%=main_type(11)%><br>
                    </font></td>
                      <td height="60" width="33"><font color="#666666" face="Geneva, Arial, Helvetica, san-serif">&nbsp;</font></td>
                      <td height="60" width="264"> 
                        <p><font color="#333399" size="2"><b>
						<A href="products.asp?id=<%=title_id(12)%>"><%=title_type(12)%></a>
						</b></font><font color="#666666" face="Geneva, Arial, Helvetica, san-serif"><br>
                     <%=main_type(12)%></font><br>
                    </p>
                  </td>
                </tr>
              </table>
        ...
        <TABLE height=131 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff 
      border=0>
          <TBODY> 
          <TR> 
            <TD width=562 height=24><IMG height=23 
            src="star/featured_pro.gif" width=564 
            border=0></TD>
          </TR>
          <TR> 
		  <%
		  ...
		  if sep_pro_reds>=4 then
		  sql="select top 4 id,name,photo from products where especially=true"
		  else
		  ...
		  %>
            <TD width=562> 
              <DIV align=center> 
                <TABLE height=131 width="95%">
                  <TBODY> 
                  <TR> 
                    <TD vAlign=top align=middle width="20%" height=127> 
                      <div align="center">
				...
				<a href="pro_detail.asp?id=<%=pro_id(2)%>"><IMG height=84 alt="<%=pro_name(2)%>" 
                  ...
                  width=99 align=center vspace=4 border=0></a><BR>
                  <a href="pro_detail.asp?id=<%=pro_id(2)%>"><%=pro_name(2)%></a></div>
                    </TD>
                    <TD vAlign=top align=middle width="20%" height=127> 
                      <div align="center">
			<a href="pro_detail.asp?id=<%=pro_id(3)%>"><IMG height=84 
                  ...
                  width=99 align=center vspace=4 border=0></a><BR>
                  <a href="pro_detail.asp?id=<%=pro_id(3)%>"><%=pro_name(3)%></a></div>
                    </TD>
                    <TD vAlign=top align=middle width="20%" height=127> 
                 <div align="center">
