  ...
  <tr>
    <td>
      <table width="370" border="0" cellspacing="0" cellpadding="0" align="center" height="140">
        <tr> 
          <td width="17"><img src="image/jx46.jpg" width="32" height="229"></td>
          <td width="320" background="image/jx47.jpg"> 
            <form name="form1" method="post" action="script/login.asp" onSubmit="return checkempty(this)">
              <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="46"><img src="image/login_01.gif" width="45" height="33"></td>
                  <td width="65">　</td>
                  <td width="89" valign="top">
<div align="right"><a href="index.asp"><font color="#939393"><strong>HOME</strong></font></a></div></td>
                </tr>
                <tr> 
                  <td><img src="image/login_03.gif" width="45" height="27"></td>
                  <td colspan="2" rowspan="2"><table width="154" height="54" border="0" cellpadding="0" cellspacing="0">
                      <tr> 
						...
						<input name="username" type="text" size="13" class="input" id="username"></td>
                          ...
                          <input type="image" src="image/login_05.gif" width="49" height="56" 
						  border="0">
                          </td>
                      </tr>
                      <tr> 
                ...
                <tr> 
                  <td><img src="image/login_06.gif" width="45" height="29"></td>
                </tr>
                <tr> 
                  <td><a href="index.asp"><font color="#939393"></font></a></td>
                  <td><a href="lost_p_w.asp" target="_blank"><img src="image/login_08.gif" width="61" height="31" border="0"></a></td>
                  <td><a href="register.asp"> 
                    <img src="image/login_09.gif" width="89" height="31" border="0"></a></td>
                </tr>
              </table>
            </form></td>
          <td width="33"><img src="image/jx46_1.jpg" width="32" height="229"></td>
        </tr>
      </table>
    </td>
  </tr>
