...
<%
		...
		'set rs1=nothing
%>
<form action="savebackdemand.asp?id=<%=id%>" method="post" name="form1">
  ...
  <table width="435" height="276" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="435" height="131" valign="top"> <table width="433" height="179" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <td width="85" height="23" valign="top">Subject:</td>
            <td width="348" valign="top"><input name="ask_subject" type="text" id="ask_subject" value="<%=rs("type")%>" size="40" readonly=""> 
              <input type="hidden" name="member" value="<%=rs("memberid")%>"></td>
          </tr>
          <tr> 
            <td height="22" valign="top">Date:</td>
            <td valign="top"><input name="ask_date" type="text" id="ask_date" value="<%=rs("demand_time")%>" size="40" readonly=""></td>
          </tr>
          <tr> 
            <td valign="top">Product:</td>
            <td valign="top"><input name="ask_product" type="text" id="ask_product" value="<%=rs("pro_name")%>" size="40" readonly=""></td>
          </tr>
          <tr> 
            <td height="96" valign="top">To Know:</td>
            <td valign="top"> 
<textarea name="ask_toknow" cols="40" rows="5" readonly id="ask_toknow">
Expected Price: <%=rs("price")%>
Expected delivery time: <%=rs("time")%>
Notes: <%=rs("notes")%>
</textarea></td>
          </tr>
        </table></td>
