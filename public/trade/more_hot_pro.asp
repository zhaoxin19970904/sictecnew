      ...
      border=0>
          ...
          <TR> 
                <TD width=573 height=18><font color="#666666" size="2">You are 
                  ...
                  Hot Sale Room</strong></font></a> 
                  <%
				  sql="select id,photo,name,model,type,type_id from products where recommended=true order by up_date desc"
					 rs.open sql,conn,1,1
					 type_type=rs("type")
					if rs.eof then
			%>
...
%>
                                <a href="more_hot_pro.asp?page=<%=iPage-1%>"><b>Pre</b></a>&nbsp; 
                                <%end if%>
...
%>
                                <a href="more_hot_pro.asp?page=<%=iPage+1%>">&nbsp;<b>Next</b></a> 
<%
end if
%>
                                &nbsp;&nbsp;&nbsp;</font></div></td>
                            ...
                            <td width="279" height="18"><table width="277" height="19" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <td width="167"><table width="167" height="92" border="0" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr> 
                                        <td width="95" height="18"><div align="center"><font size="2"><b> 
                                            <a href="script/basket.asp?pro_id=<%=id(i)%>&type_id=<%=typeid(i)%>" class="A2" target="_blank">Add 
                                            To Basket</a> </b></font></div></td>
                                        <td width="72"><div align="center"> <a href="inquiry.asp?pro_id=<%=id(i)%>" target="_blank"> 
                                            <img src="images/inquire.jpg" width="46" height="15" border="0"> 
                                            </a> </div></td>
                                      </tr>
                                    </table></td>
                                </tr>
							...
							<table width="277" height="19" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="167"><table width="167" height="91" border="0" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr> 
                                        <td width="95" height="18"><div align="center"><font size="2"><b>
										<a href="script/basket.asp?pro_id=<%=id(i)%>&type_id=<%=typeid(i)%>" class="A2" target="_blank">Add To Basket</a>
                                            </b></font></div></td>
                                        <td width="72"><div align="center">
										<a href="inquiry.asp?pro_id=<%=id(i)%>" target="_blank">
										<img src="images/inquire.jpg" width="46" height="15" border="0">
										</a>
										</div></td>
                                      </tr>
