                ...
                <tr> 
                  <td height="45" valign="top" bgcolor="#FFFFFF"> 
                    <div align="center"> 
                      ...
                      means required information!)</FONT></span></div></td>
                </tr>
                <tr> 
                      ...
                      <TBODY>
                        <TR> 
                          <TD vAlign=top align=middle width="100%" height=930> 
                            <form name="form2" method="post" action="script04/mail.asp" onSubmit="return check(this)">
...
border=0 align=center cellPadding=4 cellSpacing=1 class="unnamed1">
                                <TBODY>
                                  <TR> 
                                    <TD width="24%" height=28 align=right> <FONT color=#ff3300>*</FONT><B> 
                                      Member ID:</B><BR></TD>
                                    <TD width="76%" height=28 vAlign=top> <INPUT class=fonten 
                  id=member_uid2 size=30 name=member_id> </TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right height=28> <FONT color=#ff3300>*</FONT><B> 
                                      Setup password:</B><BR></TD>
                                    <TD height=28><INPUT class=fonten id=psd2 type=password 
                  size=30 name=psd> </TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right height=28><FONT color=#ff3300>*</FONT> 
                                      <B>Re-enter password:</B><BR></TD>
...
border=0 align=center cellPadding=4 cellSpacing=1 class="unnamed1">
                                <TBODY>
                                    ...
                                    <TD height=29> <table width="200" height="24" border="0" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td width="100" height="24"><div align="center"> 
                                              <input name=firstname class=fonten id=firstname size="8">
                                            </div></td>
                                          <td width="100"><div align="center"> 
                                              <input name=lastname class=fonten id=lastname size="8">
                                            </div></td>
                                        </tr>
                                      </table></TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right height=29> <STRONG>Sex:<B></B></STRONG></TD>
                                    <TD height=29> <INPUT name=sex type=radio value=male CHECKED>
                                      Male 
                                  ...
                                  <TR> 
                                    ...
                                    <TD height=28><INPUT class=fonten id=jobtitle2 name=jobtitle> 
                                    </TD>
                                  </TR>
                                  <TR> 
                ...
                name=email>
                                  ...
                                  <TR> 
                                    ...
                                    <TD width="76%" colSpan=2 height=28> <input name="country" type="text" id="country" size="35"> 
                                    </TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right width="24%" height=28><B>City:</B></TD>
                                    <TD width="76%" colSpan=2 height=28> <input name="city" type="text" id="city" size="35"> 
                                    </TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right width="24%" height=28><B>Address:</B></TD>
                                    <TD width="76%" colSpan=2 height=28><INPUT class=fonten 
                  id=address2 size=55 name=address></TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right width="24%" height=28><B>Postal 
                                      code:</B></TD>
                                    <TD width="76%" colSpan=2 height=28><INPUT class=fonten 
                  id=post2 size=40 name=post></TD>
                                  </TR>
                                </TBODY>
                              </TABLE>
                              <BR>
...
border=0 align=center cellPadding=4 cellSpacing=1 class="unnamed1">
                  ...
                  color=#ff0000>*</FONT><B>&nbsp;Company name:</B></div></TD>       
                                    <TD width="76%" colSpan=2 height=28> <INPUT class=fonten id=company2 size=45 name=company> 
                                    </TD>
                                  </TR>
                                  <TR> 
                  ...
                  color=#ff0000>*</FONT><B>Major business area:</B><BR>
                                    ...
                                    <TD height=28> <input name="area" type="text" id="area" size="45"> 
                                    </TD>
                                  </TR>
                                  <TR> 
                                    ...
                                    <TD> <P> 
                                        <TEXTAREA name=main_products cols=50 rows=5 class=fonten id="textarea"></TEXTAREA>
                                      </P></TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right width="24%" height=28><div align="right"><FONT 
              ...
              name=fax></TD>
                                  ...
                                  <TR> 
                                    ...
                                    <TD height=28><textarea name="productbuy" cols="50" rows="5" id="textarea2"></textarea> 
                                    </TD>
                                  </TR>
                                  <TR> 
                                    <TD align=right width="24%" height=28><div align="right"><B>&nbsp;Products        
                                        to sell:</B></div></TD>       
                                    <TD width="76%" height=28><textarea name="productsell" cols="50" rows="5" id="textarea3"></textarea></TD>
                                  </TR>
                                  <TR> 
                                  ...
                                  <TBODY>
                                    <TR> 
                                      <TD align=middle> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                                          <TBODY>
                                            <TR> 
                                              <TD align=right width="51%"><input type="submit" name="Submit2" value="Register"> 
                                              </TD>
                                              <TD width="5%">&nbsp;</TD>
...
if (form1.psd.value=="")
 {
    alert("Pls input setup password,thanks!")
	form1.psd.focus()
    return false
  }
