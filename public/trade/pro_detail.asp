                            ...
                            <td height="18"><table width="313" height="308" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr> 
                                  <td><table width="312" height="18" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="121" height="18" valign="top"><font size="2" color="#2c56aa"><b>Type:</b></font></td>
                                        <td width="191" valign="top"><font size="2" color="#666666"><%=rs("type")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td height="22"><table width="312" height="20" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="122" height="18" valign="top"> 
                                          <font size="2" color="#2c56aa"><b>Name:</b></font> </td>
                                        <td width="190" valign="top"><font size="2" color="#666666"><%=rs("name")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="313" height="19" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        ...
                                        <td width="191" valign="top"><font size="2" color="#666666"><%=rs("model")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="312" height="19" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="121" height="18" valign="top"><font size="2" color="#2c56aa"><b>Brand 
                                          Name:</b></font></td>
                                        <td width="191" valign="top"><font size="2" color="#666666"><%=rs("brandname")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="313" height="18" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="121" height="18" valign="top"><font size="2" color="#2c56aa"><b>Region:</b></font></td>
                                        <td width="192" valign="top"><font size="2" color="#666666"><%=rs("region")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="311" height="19" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="119" height="18" valign="top"><font size="2" color="#2c56aa"><b>Quality 
                                          Approvals:</b></font></td>
                                        <td width="192" valign="top"><font size="2" color="#666666"><%=rs("approvals")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="313" height="20" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="119" height="18" valign="top"><font size="2" color="#2c56aa"><b>Packing:</b></font></td>
                                        <td width="194" valign="top"><font size="2" color="#666666"><%=rs("packing")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="313" height="18" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="119" height="18" valign="top"> 
                                          <font size="2" color="#2c56aa"><b>Main 
                                          export markets:</b></font> </td>
                                        <td width="194" valign="top"><font size="2" color="#666666"><%=rs("main_export_markets")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="313" height="19" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="118" height="18" valign="top"><font size="2" color="#2c56aa"><b>Pament 
                                          terms:</b></font></td>
                                        <td width="195" valign="top"><font size="2" color="#666666"><%=rs("payment_terms")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="312" height="19" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="118" height="18" valign="top">
										<font size="2" color="#2c56aa"><b>
										delivery time:</b></font></td>
                                        <td width="194" valign="top"><font size="2" color="#666666"><%=rs("lead_time")%></font></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr> 
                                  <td><table width="312" height="20" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                        <td width="120" height="18" valign="top"><font size="2" color="#2c56aa"><b>
										Sample availability:</b></font></td>
                                        <td width="192" valign="top"><font size="2" color="#666666"> 
                                          <%
										sample=rs("sample")
