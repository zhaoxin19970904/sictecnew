...
<%
  ...
  sql="select type,modelno,introduction from products where id="&id&""
...
<table width="606" border="0" align="center" cellpadding="0" cellspacing="0" class="info">
  ...
  <tr> 
    ...
    <td> <div align="center"><%=rs("modelno")%></div>
      <div align="center"></div></td>
  </tr>
  <tr valign="bottom"> 
    <td height="45" colspan="2"> <div align="center"><font color="#003366"><%=rs("introduction")%></font></div></td>
  </tr>
</table>
