...
<body bgcolor="#FFFFFF" topMargin=0 text="#000000" bottommargin="0">
                            ...
                            <tr> 
                              <td bgcolor="#FFFFFF" height="106" valign="top"> 
                                <table width="152" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="152" background="../imgs/bg_03.gif"> 
                                      <p> 
                                        <%
...
%>
                  ...
                  <td width="788" valign="top" height="379"> 
                    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="428">
                      <tr> 
                        <td>
                          <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="22">
                            <tr> 
                              <td width="217" height="41"> 
                                <div align="center"><font size="3"> <img src="star/modelshowroom.jpg" width="138" height="13"></font></div>
                              </td>
					 ...
					 rs.open sql,conn,1,1
	 if rs.eof then
          response.write "Sorry, No model found."
          response.end
     end if
...
%>
                          ...
                          <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="8">
                            <tr> 
                              <td valign="middle" height="5" align="left" width="240"> 
                                <table width="200" border="0" cellspacing="0" cellpadding="0" align="left">
                                  <tr> 
                                    <td width="110" height="5" bgcolor="#3399CC"></td>
                                    <td width="240" height="5" bgcolor="#B5DAEC"></td>
                                  </tr>
                                </table>
                              </td>
                              <td valign="middle" height="5" align="left" width="240"> 
                            ...
                            <tr> 
                              <td width="355" height="107" valign="top"> 
                                ...
                                <table width="180" border="0" cellspacing="0" cellpadding="0" height="131">
                                  <tr> 
                                    <td height="150"> 
                                      <table width="159" border="0" cellspacing="0" cellpadding="0" height="139" background="star/hyh_d.jpg" align="center">
                                        <tr> 
                                          <td bgcolor="#FFFFFF"> <a href="#" onClick="javascript:window.open('showmodel.asp?id=<%=id(i)%>','','width=600,height=600,toolbar=no,location=no,directories=no,status=no,resizable=no,scrollbars=yes','')"> 
                                            <img src="manage/script/photo1/<%=trim(photo1(i))%>" width="151" height="131" border="0"> 
                                            </a> </td>
                                        </tr>
                                      </table>
                                    </td>
                                ...
                                <table width="181" border="0" cellspacing="0" cellpadding="0" align="left" height="24">
                                  <tr> 
                                    <td> 
                                      <div align="center"><font size="2"> <%=m_name(i)%>&nbsp;&nbsp;&nbsp; 
                                        <%i=i+1%>
                                        </font></div>
                                    </td>
                                  </tr>
                              ...
                              <td width="355" height="107" valign="top"> 
                                ...
                                <table width="180" border="0" cellspacing="0" cellpadding="0" height="131">
                                  <tr> 
                                    <td height="150"> 
                                      <table width="151" border="0" height="131" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC" align="center">
                                        <tr> 
                                          <td width="153" bgcolor="#FFFFFF"> <a href="#" onClick="javascript:window.open('showmodel.asp?id=<%=id(i)%>','','width=600,height=600,toolbar=no,location=no,directories=no,status=no,resizable=no,scrollbars=yes','')"> 
                                            <img src="manage/script/photo1/<%=trim(photo1(i))%>" width="151" height="131" border="0"> 
                                            </a> </td>
                                        </tr>
                                      </table>
...
%>
                              ...
                              <td width="355" height="107" valign="top"> 
                                ...
                                <table width="180" border="0" cellspacing="0" cellpadding="0" height="131">
                                  <tr> 
                                    <td height="150"> 
                                      <table width="151" border="0" cellspacing="0" cellpadding="0" height="131" bgcolor="#CCCCCC" align="center">
                                        <tr> 
                                          <td bgcolor="#FFFFFF"> <a href="#" onClick="javascript:window.open('showmodel.asp?id=<%=id(i)%>','','width=600,height=600,toolbar=no,location=no,directories=no,status=no,resizable=no,scrollbars=yes','')"> 
                                            <img src="manage/script/photo1/<%=trim(photo1(i))%>" width="151" height="131" border="0"> 
                                            </a> </td>
...
%>
                      ...
                      <tr> 
                        <td>
                          <table align="right" class="text">
                            <tr> 
                              <td height="21"> 
                                <div align="right">Page No.<font color="#FF0000"> 
...
%>
                                  <font class="dateformat"> <a href="showprodir.asp?page=1&class_name=<%=class_name%>">First 
                                  Page</a> </font> | <font class="dateformat"> 
                                  <a href="showprodir.asp?page=<%=iPage-1%>&class_name=<%=class_name%>">Previous</a> 
                                  </font> | 
                                  <%end if%>
                                  <%
...
%>
                                  ...
                                  <%else%>
                                  <a href="showprodir.asp?page=<%=iPage+1%>&class_name=<%=class_name%>"> 
                                  Next</a> | <a href="showprodir.asp?page=<%=rs.pagecount%>&class_name=<%=class_name%>"> 
                                  Last Page</a> 
                                  <%
end if
%>
