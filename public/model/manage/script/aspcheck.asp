...
<tr><td>
	...
	<table width=500 border=0 cellpadding=0 cellspacing=1 bgcolor="#989DA5">
...
<br>■ IIS自带的ASP组件
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#989DA5" width="500">
	<tr height=18 class=backs align=center><td width=320 bordercolor="#989DA5">组 件 名 称</td>
		<td width=130 bordercolor="#989DA5">支持及版本</td></tr>
	<%For i=0 to 10%>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#989DA5" width="500">
	...
	<%For i=24 to 25%>
	<tr height="18" class=backq>
		<td height="39" align=left>&nbsp;<%=ObjTotest(i,0) & "<font color=#888888>&nbsp;" & ObjTotest(i,1)%></font></td>
		<td align=left>&nbsp;<%
		If Not ObjTotest(i,2) Then 
			Response.Write "<font color=red><b>×</b></font>"
		Else
...
<table class=backq border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#989DA5" width="500">
  <tr height=18 class=backs align=center> 
    <td width=320>服&nbsp;&nbsp;&nbsp;务&nbsp;&nbsp;&nbsp;器</td>
    <td width=130>完成时间</td>
  </tr></tr>
  <tr height=18> 
    <td align=left>&nbsp;<a target="_blank" href="http://www.freedown.net/">凡人网络FreeDown.Net主机</a>（2002-08-06 9:29）</td>
    <td>&nbsp;357.8 毫秒</td>
  </tr>
  <form action="<%=Request.ServerVariables("SCRIPT_NAME")%>" method=post>
    <%

	'感谢网际同学录 http://www.freedown.net 推荐使用timer函数
