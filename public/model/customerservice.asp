  ...
  <tr>
    <td valign="top"> 
      <table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="198">
          <tr> 
            <td valign="top"> 
              <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="249">
                <tr> 
                            ...
                            <tr> 
                              <td bgcolor="#FFFFFF" height="106" valign="top"> 
                                <table width="161" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="159" background="../imgs/bg_03.gif"> 
                                      <p> 
                                        <%
                    ...
                    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="22">
                      <tr> 
                        <td width="217" height="41"> 
                          <div align="center"><img src="star/customerservice.jpg" width="142" height="13"></div>
                        </td>
