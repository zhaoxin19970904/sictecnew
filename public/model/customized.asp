  ...
  <tr>
    <td valign="top"> 
      <table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="182">
          <tr> 
            <td valign="top"> 
              <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="211">
                <tr> 
                            ...
                            <tr> 
                              <td bgcolor="#FFFFFF" height="106" valign="top"> 
                                <table width="161" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="162" background="../imgs/bg_03.gif"> 
                                      <p> 
                                        <%
                    ...
                    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="22">
                      <tr> 
                        <td width="217" height="41"> 
                          <div align="center"><img src="star/customized.jpg" width="94" height="13"></div>
                        </td>
