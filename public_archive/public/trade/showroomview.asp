...
title_id1=request.QueryString("title_id")
sql="select * from type where type_id="&type_id&""
sql1="select * from main where main_id="&main_id&""
sql2="select * from title where title_id="&title_id1&""
set rs=conn.execute(sql)
set rs1=conn.execute(sql1)
set rs2=conn.execute(sql2)
type_type=rs("type")
main_type=rs1("main_type")
title_type1=rs2("title_type")
rs.close
rs1.close
rs2.close
%>
...
//-->
        ...
        <TABLE height=291 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff 
      border=0>
            <TBODY> 
          <TR> 
                <TD width=573 height=18><font color="#666666" size="2">You are 
                  here</font>: <a href="index.asp" class="A1"><font size="2"><strong>Show 
                  Room</strong></font></a><font color="#000066">&gt;</font><font color="#2c56aa" size="2"><b><A href="products.asp?id=<%=title_id1%>" class="a1"><%=title_type1%></a></b></font><font color="#000066">&gt;</font><font color="#2c56aa" size="2"><b><A href="products.asp?id=<%=title_id1%>" class="a1"><%=main_type%></a></b></font><font color="#000066">&gt;</font><font color="#2c56aa" size="2"><b><%=type_type%></b></font>
				  
				  <%
				  sql="select id,photo,name,model,type_id from products where type_id="&type_id&" order by up_date desc"
					 rs.open sql,conn,1,1
					if rs.eof then
			%>
			
<script language="JavaScript">
   alert("No products of this type!")
                            ...
                            <td width="279" height="18"><table width="277" height="19" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <td width="167"><table width="167" height="92" border="0" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr> 
                                        <td width="95" height="18"><div align="left"><font size="2"><b> 
                                            <a href="script/basket.asp?pro_id=<%=id(i)%>&type_id=<%=typeid(i)%>" class="A2" target="_blank"> 
                                            <img src="images/basket.jpg" border="0">
											</a> </b></font></div></td>
                                        <td width="72"><div align="center"> <a href="inquiry.asp?pro_id=<%=id(i)%>" target="_blank"> 
			...
			%>
							<table width="277" height="19" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="167"><table width="167" height="91" border="0" cellpadding="0" cellspacing="0">
                                      <tr> 
                                      ...
                                      <tr> 
                                        <td height="55" colspan="2"><font size="2" color="#666666"><%=type_type%> (<%=p_name(i)%>)</font></td>
                                      </tr>
                                      <tr> 
                                        <td width="95" height="18"><font size="2"><b> 
                                          <a href="script/basket.asp?pro_id=<%=id(i)%>&type_id=<%=typeid(i)%>" class="A2" target="_blank"> 
                                           <img src="images/basket.jpg" border="0">
										  </a> </b></font></td>
                                        <td width="72"><div align="center"> <a href="inquiry.asp?pro_id=<%=id(i)%>" target="_blank"> 
