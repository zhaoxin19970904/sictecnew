...
border=0>
                              ...
                              size=3><STRONG><img src="images/search.jpg" width="13" height="13">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  Search:</STRONG></FONT><STRONG><FONT 
...
width="100%">
              ...
              <tr>
                <td><table width="768" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td colspan="4" height="28"> 
                        <table width="766" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="639"><strong><font color="#000099">Your 
                              all reversions</font></strong></td>
                            <td width="127"><div align="center">
							<a href="script/deleteback.asp?action=all" onClick="return ifdelete()">Clear 
                                All</a></div></td>
                          </tr>
                        </table>
                    ...
                    <tr> 
                      <td width="83" bgcolor="#f8f8ff"><div align="center">
						<strong><font size="3" color="#000066">Status</font></strong></div></td>
                      <td width="306"bgcolor="#e5f3fc"><div align="center"><font color="#000066" size="3"><strong>Subjec</strong></font><strong><font color="#000066">t</font></strong></div></td>
                      <td width="252" bgcolor="#f8f8ff"><div align="center"><strong><font color="#000066" size="3">Date</font></strong></div></td>
                      <td width="127" bgcolor="#e5f3fc"><div align="center"><strong><font color="#000066" size="3">Operate</font></strong></div></td>
                    </tr>
                    <tr> 
                      <td colspan="4"><div align="center"> 
                          ...
                          <%
					  'username=session("username")
					  sql="select id,back_subject,back_date,ifopen from back where ask_member='"&username&"' order by id desc"
					  rs.open sql,conn,1,1
 ...
 rs.cachesize=rs.pagesize
  i=0
dim id(),back_subject(),back_date(),ifopen()
do while not rs.eof and (i<rs.pagesize)
          i=i+1
     redim preserve id(i),back_subject(i),back_date(i),ifopen(i)
          id(i)=rs("id")
		  back_subject(i)=rs("back_subject")
		  back_date(i)=rs("back_date")
		  ifopen(i)=rs("ifopen")
		  rs.movenext
loop 
					  %>
                          <table width="765" height="25" border="0" cellpadding="0" cellspacing="0">
                            <%
						  i=1 
                          Do while i<=ubound(id)
						  %>
                            <tr  <%if i mod 2<>0 then response.write "bgcolor='#f8f8ff'"%>> 
                              <td width="80" height="25"> <div align="center"> 
                                  <%if ifopen(i)=true then%>
                                  <img src="images/open.jpg"> 
                                  <%else%>
                                  <img src="images/close.jpg"> 
                                  <%end if%>
                                </div></td>
                              <td width="306"><div align="center"> <a href="backcontent.asp?id=<%=id(i)%>"><%=back_subject(i)%></a> </div></td>
                              <td width="253"><div align="center"><%=back_date(i)%></div></td>
                              <td width="126"><div align="center"><a href="script/deleteback.asp?id=<%=id(i)%>" onClick="return ifdelete()">Delete</a></div></td>
                            </tr>
                            <%
						   if not rs.eof then rs.movenext
						   i=i+1
                    ...
                    <tr> 
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td colspan="2"><div align="right"><font color="#0000CC"> 
                          <%
if cint(iPage)=1 then
else
%>
                          <a href="view_back.asp?page=<%=iPage-1%>"><b>Pre</b></a>&nbsp; 
                          <%end if%>
 ...
 if cint(iPage)=cint(rs.pagecount) then
                          ...
                          <a href="view_back.asp?page=<%=iPage+1%>">&nbsp;<b>Next</b></a> 
                          <%
end if
rs.close
%>
