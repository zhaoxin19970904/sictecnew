...
<DIV align=center></DIV>
<DIV align=center> 
  <TABLE height=468 cellSpacing=0 cellPadding=0 width=770 border=0>
    <TBODY> 
    <TR> 
        ...
        <TABLE height=20 cellSpacing=0 cellPadding=0 width="100%" border=0>
          ...
          <TR> 
                <TD width="100%" height=20> <font size="2" color="#666666">You 
                  are here:<strong> </strong></font><strong><font color="#003366">My 
                  Basket</font></strong> 
...
//-->
          ...
          <TABLE height=202 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff 
      border=0>
            <TBODY> 
          <TR> 
                <TD width=574 height=24><IMG height=23 
            src="star/basket.jpg" width=564 
            border=0></TD>
          </TR>
          <TR> 
                <TD vAlign=top width=574 height=178>
<table width="574" height="409" border="0" cellpadding="0" cellspacing="0">
                    <tr bgcolor="#e5f6ff"> 
                      <td width="64" height="18"> <div align="center"><font color="#626365">
					  <strong>Operate</strong>
					  </font></div></td>
                      <td width="110"><div align="center"><font color="#626365"><strong>Product 
                          Picture</strong></font></div></td>
                      <td width="154"><div align="center"><font color="#626365"><strong>Product</strong></font></div></td>
                      <td width="116"><div align="center"><font color="#626365"><strong>Create 
                          Time</strong></font></div></td>
                      <td width="130"><div align="center"><font color="#626365"><strong>Category</strong></font></div></td>
                    </tr>
                    <tr valign="top"> 
                      <td height="373" colspan="5"> 
                        <%
	 username=session("username")
	sql="select id,photo,date,pro_name,type,productno from basket where memberid='"&username&"' order by date desc"
		rs.open sql,conn,1,1
	 if rs.eof then
%>
<script language="JavaScript">
...
<%
          'response.write "Sorry,there is no products of this type for the moment!"
          response.end
     end if
...
if len(request("page"))=0 then
 ...
 rs.cachesize=rs.pagesize
  i=0
dim id(),pro_photo(),p_name(),p_date(),p_type(),productno()
do while not rs.eof and (i<rs.pagesize)
          i=i+1
     redim preserve id(i),pro_photo(i),p_name(i),p_date(i),p_type(i),productno(i)
          id(i)=rs("id")
		  p_name(i)=rs("pro_name")
		  p_type(i)=rs("type")
		  productno(i)=rs("productno")
...
%> <table width="100" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <table width="573" border="0" cellspacing="0" cellpadding="0">
                          <tr <%if i mod 2=0 then response.Write("bgcolor=#f8f8ff") else response.Write "" end if%>> 
                            <td width="64"><div align="center"><font color="#0000CC"><strong>
							<a href="script/delbasket.asp?id=<%=id(i)%>" onClick="return ifdelete()">Delete</a> 
                                </strong>&nbsp;</font> </div></td>
                            <td width="110"><div align="center"> <a href="pro_detail.asp?id=<%=productno(i)%>" target="_blank"> 
                                <img src="admin/script/prophotos/<%=pro_photo(i)%>" height="92" width="92" border="0"> 
                                </a> </div></td>
                            <td width="154"><div align="center"> <a href="pro_detail.asp?id=<%=productno(i)%>" target="_blank"><%=p_type(i)%>(<%=p_name(i)%>)</a></div></td>
                            <td width="116"><div align="center"> <%=p_date(i)%> </div></td>
                            <td width="129"><div align="center"> <%=p_type(i)%> </div></td>
                          </tr>
                        </table>
                        <%
i=i+1
...
%>
                    ...
                    <tr> 
                      <td height="18" colspan="5"><table width="572" height="18" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="265" height="18"> <div align="left"><font color="#0000CC"> 
                                <%
if cint(iPage)=1 then
else
%>
                                <a href="viewbasket.asp?page=<%=iPage-1%>"><b>Pre</b></a>&nbsp; 
                                <%end if%>
 ...
 if cint(iPage)=cint(rs.pagecount) then
                                ...
                                <a href="viewbasket.asp?page=<%=iPage+1%>">&nbsp;<b>Next</b></a> 
                                <%
end if
rs.close
%>
                            ...
                            <td width="307"><div align="right">
                                <div align="right"><font color="#0000CC"> &nbsp;&nbsp; 
                                  <strong><a href="script/delbasket.asp?action=all" onClick="return ifyes()">Clear All</a></strong> &nbsp;&nbsp;&nbsp;&nbsp; 
...
<SCRIPT language=JavaScript>
	...
	{
  var fig=false
  fig=confirm("Delete all products of basket?")
  return fig
}
