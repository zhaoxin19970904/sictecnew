        ...
        <TABLE height=20 cellSpacing=0 cellPadding=0 width="100%" border=0>
          ...
          <TR> 
                <TD width="100%" height=20><font color="#666666">You are here:</font> 
                  <strong><font color="#000066">View Reversion</font></strong> 
...
//-->
      ...
      border=0>
          <TBODY> 
          <TR> 
                <TD width=575 height=24><IMG height=23 
            src="star/back.jpg" width=564 
            border=0></TD>
          </TR>
          <TR> 
...
<table width="574" height="178" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td height="22" colspan="2"> 
                              <div align="center"><font color="#003366"><strong>Answer</strong></font></div></td>
                          </tr>
                          <tr> 
