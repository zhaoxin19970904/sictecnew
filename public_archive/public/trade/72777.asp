...
<body onLoad="MM_preloadImages('star/msh_company1.jpg','star/msh_contact1.jpg','star/msh_product1.jpg')">
<div align=center> 
  <div align=center>
    ...
    <table height=16 cellspacing=0 cellpadding=0 width=770 border=0>
      ...
      <tr> 
        ...
        <td width=99 height=21> 
          <div align="right"><a href="index.asp" target="_blank"> </a><img src="star/msh_home.jpg" width="82" height="24"></div>
        </td>
        ...
        <td width=136 height=21> 
          <div align="right"><a href="for_buyer.asp" targer="_blank"> </a><a href="for_buyer.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','star/msh_company1.jpg',1)"><img name="Image10" border="0" src="star/msh_company.jpg" width="128" height="24"></a></div>
        </td>
        <td width=120 height=21> 
          <div align="right"><a href="favorite.asp" targer="_blank"> </a><a href="contact.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image11','','star/msh_contact1.jpg',1)"><img name="Image11" border="0" src="star/msh_contact.jpg" width="114" height="24"></a></div>
        </td>
      </tr>
      </tbody> 
    </table>
