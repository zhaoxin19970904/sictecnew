...
%>
<p align="center" class="datāeformat"><font color="#000066" size="4">客户的购物信息<br>
...
<table width="957" height="58" border="0" align="center"  cellpadding="4" cellspacing="1" bgcolor="#293863">
 ...
 %>
  <tr bgcolor="#fafbfd"> 
    ...
    <td  class="chinese"><div align="center">
	 <a href="dealclient.asp?id=<%=rs("id")%>&table=basket" onClick="return confirmdel()">删除</a></div></td>
  </tr>
  <%
 end if
...
%>
  <a href="viewbasket.asp?page=1">第一页</a> | <a href="viewbasket.asp?page=<%=iPage-1%>">上一页</a> 
  | 
  <%end if%>
  <%
...
%>
  ...
  <%else%>
  <a href="viewbasket.asp?page=<%=iPage+1%>">下一页</a> | <a href="viewbasket.asp?page=<%=rs.pagecount%>">最后一页</a> 
  <%
end if
rs.close
set rs=nothing
  ...
  <table width="508" height="16" border="0" align="center" cellpadding="0" cellspacing="0" class="chinese">
    <tr>
      ...
      <td width="106"> <div align="left">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;|</div></td>
      <td width="120"><input type="button" name="Submit3" value="显示全部" class="button" onClick="javascript:location.href='viewbasket.asp'"></td>
      <td width="14">&nbsp;</td>
    </tr>
  </table>
</form>
