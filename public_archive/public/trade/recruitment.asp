      ...
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            ...
            <td width="75%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td height="34" valign="top"><img src="image/banner07.jpg" width="599" height="34" border="0" usemap="#Map"></td>
                </tr>
                <tr> 
                  <td height="138" valign="top"><img src="image/pho19.jpg" width="599" height="139"></td>
                </tr>
                <tr> 
                  <td height="25" valign="top" background="image/bg12.jpg"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td width="94%" height="35" valign="bottom"><img src="image/bg22.jpg" width="140" height="19"></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td height="9" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="unnamed1">
                      <tr>
                        <td class="unnamed2"><strong>Position: Business Analyst</strong></td>
                      </tr>
                      <tr> 
                        <td><strong><font color="#990000">Position description:</font></strong> 
                          <br>
                          <strong>&raquo;</strong> Market survey: Collect information 
                          from different sources including online searches, magazines 
                          and newspapers, telephone interviews, face to face interviews<br> <strong>&raquo;</strong> 
                          Business plan analysis. Analyze market information, 
                          source Chinese products and find business opportunity.<br> 
                          <strong>&raquo;</strong> Negotiation and coordination 
                          with foreign clients and Chinese counterparts <br> <strong>&raquo;</strong> 
                          Assistance in execution of export and import business<br> 
                          <strong>&raquo;</strong> Building good relationship 
                          with business partners <br> <strong>&raquo;</strong> 
                          Writing research and analysis report<br>
                          <strong>&raquo;</strong> Documental work <br>
                          <br>
                          <font color="#990000"><strong>Qualifications: </strong></font><br> <strong>&raquo;</strong> Bachelor’s degree or above 
                          required. <br> <strong>&raquo;</strong> 5 years + overall 
                          experience.<br> <strong>&raquo;</strong> Understanding 
                          of China business practices. <br> <strong>&raquo;</strong> 
                          Quick learner, energetic, self-motivated, and details-oriented<br> 
                          <strong>&raquo;</strong> Self initiative, team player, 
                          with solid communication skills<br> <strong>&raquo;</strong> 
                          Good command of English and Chinese. <br> <strong>&raquo;</strong> 
                          Foreign trade knowledge a strong plus.<br> <strong>&raquo;</strong> 
                          Industry expertise a plus<br>
                          <strong>&raquo;</strong> Overseas experience a plus 
                          <br>
                          <br>
                          Please send your resume (in both English and Chinese), 
                          a cover letter detailing your portfolio to hr@sictec.com 
                          . Please include your salary history and expected salary 
                          in your CV.<br> </td>
                      </tr>
                    </table></td>
                </tr>
