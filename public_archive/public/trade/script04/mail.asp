...
<script language="JavaScript">
   alert("This username has benn registered,pls change another one!")
   history.back()
   </script>
<%
response.end()
...
%>
 <script language="javascript">
   alert("The password you entered the second time is not the same with the first time, pls check")
   history.back()
 </script>
 <% 
 response.end()
...
body="<div align='center'><font color='#ff9900' size=4>[System Notification] A new member has just registered on trade-universal.com</font></div>"&"<br>"
body=body&"Member ID:"&"&nbsp;&nbsp;<font color='#cc0099'>"&member_id&"</font>"&"<br>"
body=body&"Setup password:"&"&nbsp;&nbsp;<font color='#cc0099'>"&psd&"</font>"&"<br>"
body=body&"Re-enter password:"&"&nbsp;&nbsp;<font color='#cc0099'>"&re_psd&"</font>"&"<br>"
