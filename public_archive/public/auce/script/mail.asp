...
body=body&"Chinese name:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_cname&"</font>"&"<br>"
body=body&"English name:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_ename&"</font>"&"<br>"
body=body&"Title/Position:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_position&"</font>"&"<br>"
body=body&"Organization:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_org&"</font>"&"<br><br>"
body=body&"Address:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_add&"</font>"&"<br>"
body=body&"Home address:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_homeadd&"</font>"&"<br>"
body=body&"City:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_city&"</font>"&"<br>"
body=body&"State/Province:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_prov&"</font>"&"<br>"
body=body&"Zip/Postal Code:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_code&"</font>"&"<br><br>"
body=body&"Country:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_country&"</font>"&"<br>"

body=body&"Work Phone:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_workphone&"</font>"&"<br>"
body=body&"Home phone:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_homephone&"</font>"&"<br>"
body=body&"Fax:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_fax&"</font>"&"<br>"
body=body&"Email:"&"&nbsp;&nbsp;<font color='#cc0099'>"&e_mail&"</font>"&"<br><br>"
body=body&"URL:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_url&"</font>"&"<br>"

body=body&"Areas of Specification and Experience:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_exp&"</font>"&"<br>"
body=body&"Other:"&"&nbsp;&nbsp;<font color='#cc0099'>"&txt_other&"</font>"&"<br>"

body=body&"Individual Member:"&"&nbsp;&nbsp;<font color='#cc0099'>"&individual&"</font>"&"<br>"
body=body&"Organizational Member:"&"&nbsp;&nbsp;<font color='#cc0099'>"&organizational&"</font>"&"<br>"

body=body&"Yes:"&"&nbsp;&nbsp;<font color='#cc0099'>"&yes&"</font>"&"<br>"
body=body&"No:"&"&nbsp;&nbsp;<font color='#cc0099'>"&no&"</font>"&"<br><br>"
