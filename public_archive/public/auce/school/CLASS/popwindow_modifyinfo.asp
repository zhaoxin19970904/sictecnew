...
if act="del" then
   ...
   if not rs.eof then
      ...
      Session.Abandon
      response.redirect "../success.asp?info=您已经注销了在该班级的身份，而且您现在没有加入任何一个班级，<a href='http://www.88com.cn/alumni'>请点这里</a>,登陆后重新注册班级！"
   end if
   rs.close
end if
...
<IMG 
                ...
                注册新班</a></TD></TR></TBODY></TABLE></TD></TR>
        </TBODY></TABLE>
  ...
  <tr>
    <td align="center" valign="top" width="462"> <br>
      <table width="455" border="0" cellspacing="2" cellpadding="2">
        <tr> 
          <td class="topic" width="447">修改个人信息<br>
            　</td>
        </tr>
      </table>
      <table width="450" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111">
        <form name="form1" method="post" action="modifyinfo.asp">
          <tr> 
            <td width="130" align="right" class="topic">真实姓名：<br>
            </td>
          ...
          <tr> 
            <td width="130" align="right" class="topic">昵称（笔名）：</td>
            <td width="370" class="topic"> 
              <input type="text" name="dearname" value=<%=dearname%> size="20">
            </td>
          </tr>
          <tr> 
            <td width="130" align="right" class="topic">个人新密码：</td>
            <td width="370" class="topic"> 
