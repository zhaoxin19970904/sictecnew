...
<table width="363" height="211" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td height="18" width="315"><%=pro_type%>　</td>
  </tr>
  <tr> 
    <td height="19"><font color="#6699cc" size="2">Model:</font></td>
    <td height="19"><%=modelno%></td>
  </tr>
  <tr> 
    <td height="19" width="48"><font color="#6699cc">Price：</font></td>
    <td height="19" width="315">$&nbsp;<%=price%>　</td>
  </tr>
  <tr> 
...
<div align="left"><font color="#6699cc">Product 
              Introduction：</font></div></td>
        </tr>
        <tr> 
          <td height="52" valign="bottom"> <div align="left"><%=intro%></div></td>
        </tr>
      </table></td>
  </tr>
</table>
