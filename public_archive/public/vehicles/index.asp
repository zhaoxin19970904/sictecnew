...
%>
                                  <font class="text"><a href="index.asp?page=1">First 
                                  </a></font> <font class="text"><a href="index.asp?page=<%=iPage-1%>">Back</a></font> 
                                  <%end if%>
                                  <%
 if cint(iPage)=cint(pages) or cint(inputpage)=cint(pages) then
%>
                                  <font class="text">Next Last</font> 
                                  <%else%>
                                  <a href="index.asp?page=<%=iPage+1%>"> Next</a><a href="index.asp?page=<%=pages%>"> 
                                  Last</a> 
                                  <%
end if
%>&nbsp;&nbsp;&nbsp;
