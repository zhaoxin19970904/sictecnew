...
%>
                                  <font class="dateformat">Fist Page | Previous | </font> 
                                  <%
else
%>
                                  <a href="showprodir.asp?page=1&class_name=<%=class_name%>">
                                First Page</a> | <a href="showprodir.asp?page=<%=iPage-1%>&class_name=<%=class_name%>">
                                Previous</a> | 
                                  <%end if%>
                                  <%
 if cint(iPage)=cint(rs.pagecount) or cint(inputpage)=cint(rs.pagecount) then
%>
                                  <font class="dateformat">Next Page | Last Page </font> 
                                  <%else%>
                                  <a href="showprodir.asp?page=<%=iPage+1%>&class_name=<%=class_name%>">
                                Next Page</a> | <a href="showprodir.asp?page=<%=rs.pagecount%>&class_name=<%=class_name%>">
                                Last Page</a> 
                                  <%
end if
%>
      ...
      <table width="948" border="0" cellspacing="0" cellpadding="0" align="center" height="63">
        <tr valign="top"> 
          <td width="9"><img src="star/hyh_2_6.jpg" width="9" height="81"></td>
            <td width="935" background="star/hyh_2_8.jpg">&nbsp; </td>
