...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="98%">
  <tr>
      <td valign="top"> 
        ...
        <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="261">
          <tr> 
            <td valign="top"> 
              <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="275">
                <tr> 
                  <td width="159" valign="top" height="302"> 
                            ...
                            <tr> 
                              <td bgcolor="#FFFFFF" height="106" valign="top"> 
                                <table width="161" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr> 
                                    <td width="151" background="../imgs/bg_03.gif"> 
                                      <p> 
                                        <%
...
%>
                  ...
                  <td width="788" valign="top" height="302"> 
                    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center" height="421">
                      <tr> 
                        <td>
                      ...
                      <tr> 
                        <td height="334" valign="top"> 
                          <%
					 original=rtrim(ltrim(request.QueryString("original")))
					 mo_name=rtrim(ltrim(request.QueryString("mo_name")))
					 sql="select id,photo1,ratio,name from modeldb where original='"&original&"' and type='"&mo_name&"' order by update desc"
					 rs.open sql,conn,1,1
	 if rs.eof then
                                  ...
                                  <tr> 
                                    <td height="150"> 
                                      <table width="159" border="0" cellspacing="1" cellpadding="0" height="139" align="center" background="star/hyh_d.jpg">
                                        <tr> 
                                          <td bgcolor="#FFFFFF"> 
                                            <div align="center"> <a href="#" onClick="javascript:window.open('showmodel.asp?id=<%=id(i)%>','','width=600,height=700,toolbar=no,location=no,directories=no,status=no,resizable=no,scrollbars=yes','')"> 
...
%>
                                  <a href="showmodels.asp?page=1&original=<%=original%>&mo_name=<%=mo_name%>">First 
                                  Page</a> | <a href="showmodels.asp?page=<%=iPage-1%>&original=<%=original%>&mo_name=<%=mo_name%>">Previous</a> 
                                  | 
                                  <%end if%>
                                  <%
...
%>
                                  ...
                                  <%else%>
                                  <a href="showmodels.asp?page=<%=iPage+1%>&original=<%=original%>&mo_name=<%=mo_name%>">Next</a> 
                                  | <a href="showmodels.asp?page=<%=rs.pagecount%>&original=<%=original%>&mo_name=<%=mo_name%>">Last 
                                  Page</a> 
                                  <%
end if
%>
