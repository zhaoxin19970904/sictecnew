...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="98%">
  <tr>
                          ...
                          <table width="181" border="0" cellspacing="0" cellpadding="0" align="center" height="235">
                            <tr> 
                              <td bgcolor="#FFFFFF" height="106" valign="top"> 
                                <table width="135" border="0" align="center" cellpadding="0" cellspacing="0" class="menu">
                                  <tr> 
	...
	%>
                                        <TR>
                                          <td> <a href="javascript:onChange(<%=j%>)"> 
                                            <b><font size="3" color="#3399CC">+</font></b> 
                                            </a> &nbsp; <a href='showprodir.asp?class_name=<%=rs("class_name")%>'> 
                                            <font size="2" color="#003399"> <%=rs("class_name")%></font></a> 
                                          </td>
                                        </TR>
...
%>
                                        <tr> 
                                          <td width="19"><img align="absMiddle" src="images/line_tri.gif" width="19" height="16"></td>
                                          <td width="9"><img align="absMiddle" src="images/reddot.gif" width="6" height="11">&nbsp;</td>
                                          <td width="90"> <a href="showmodels.asp?original=<%=original%>&mo_name=<%=mo_name%>"> 
