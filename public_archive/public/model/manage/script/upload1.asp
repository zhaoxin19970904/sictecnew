...
<form name="form1" method="post" action="saveuploadpic1.asp" enctype="multipart/form-data" onsubmit="return check(this)">
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="25" align="center"> <p>上传<font color="#FF0000"> 小</font> ( Small 
          )图片&nbsp;&nbsp;&nbsp;</p>
        <p>&nbsp; 
        ...
        <p><a href="viewmodel.asp">不修改图片</a></p></td>
    </tr>  </table>
  </form> 
</body>  
</html>