...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="98%">
  <tr>
      <td valign="top"> 
        ...
        <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="204">
          <tr>
          <td valign="top">
              <table width="947" border="0" cellspacing="0" cellpadding="0" align="center" height="252">
                <tr> 
                  <td width="159" valign="top" height="284"> 
...
%>
                  ...
                  <td width="788" valign="top" height="284"> 
...
sql="select id,photo1,ratio,name from modeldb where type like '%"&m_type&"%' and name like '%"&m_name1&"%' and original like '%"&country&"%' order by update desc"
					 rs.open sql,conn,1,1
	 if rs.eof then
          response.write "Sorry,model not found. For more information, please contact us. Thanks. "
          response.end
     end if
...
%><font class="dateformat">First Page</font> 
                                  |
                                  <font class="dateformat">Previous</font> 
                                  | 
                                  <%end if%>
                                  <%
...
%>
                                  ...
                                  <%else%> <a href="research.asp?page=<%=iPage+1%>">
                                Next</a> 
                                  | <a href="research.asp?page=<%=rs.pagecount%>">
                                Last Page</a> 
                                  <%
end if
%>
      ...
      <table width="948" border="0" cellspacing="0" cellpadding="0" align="center" height="63">
        <tr valign="top"> 
          <td width="9"><img src="star/hyh_2_6.jpg" width="9" height="81"></td>
            <td width="935" background="star/hyh_2_8.jpg"><!--#include file="0919.asp"--> </td>
          <td width="10"><img src="star/hyh_2_7.jpg" width="9" height="81"></td>
        </tr>
      </table>
      <br>
    </td>
